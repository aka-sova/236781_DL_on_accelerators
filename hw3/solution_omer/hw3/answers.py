...
Images generated by GAN are more diverse and have the same style of the real images. According to the literature GAN should
have generated better quality images then VAE but due to the difficult training of GAN and maybe it's architecture we were unable to
generate better images than VAE.
The main differance between generated images is the loss objective, VAE try to the maximize  likelihood where in 
GAN loss objective of the discriminator and generator are competing in an adversarial manner which creates veriaty between
generated images each epoch of training.
